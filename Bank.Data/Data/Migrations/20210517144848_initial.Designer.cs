...
namespace Bank.Web.Data.Migrations
{
    ...
    [Migration("20210517144848_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bank.Data.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("Bank.Data.Models.Card", b =>
                {
            ...
            modelBuilder.Entity("Bank.Data.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("Bank.Data.Models.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bank.Data.Models.Loan", b =>
                {
            ...
            modelBuilder.Entity("Bank.Data.Models.MoneyLaunderingReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MoneyLaunderingReports");
                });
            ...
            modelBuilder.Entity("Bank.Data.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("Bank.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Bank.Data.Models.Card", b =>
                {
                    b.HasOne("Bank.Data.Models.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("Bank.Data.Models.Disposition", b =>
                {
                    b.HasOne("Bank.Data.Models.Account", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .HasConstraintName("FK_Dispositions_Accounts")
                        .IsRequired();

                    b.HasOne("Bank.Data.Models.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("Bank.Data.Models.Transaction", b =>
                {
                    b.HasOne("Bank.Data.Models.Account", "AccountNavigation")
